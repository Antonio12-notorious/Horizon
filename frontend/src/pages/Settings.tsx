...
export function Settings() {
  ...
  const [companyName, setCompanyName] = useState(
    () => localStorage.getItem("settings_company") || "CrysTech",
  );
  const [language, setLanguage] = useState(
    () => localStorage.getItem("settings_language") || "Português (Moçambique)",
  );
  ...
  return (
    <div className="space-y-8 max-w-5xl pb-20 px-4 md:px-8">
      <div>
        <h1 className="text-4xl font-black ml-2 tracking-tight text-gray-900 dark:text-white mb-2">
          Configurações
        </h1>
        <p className="text-gray-500 ml-2 dark:text-gray-400 font-medium">
          Gerencie as preferências globais
        </p>
      </div>

      <div className="flex flex-col md:flex-row gap-8">
        {/* Sidebar */}
        <div className="w-full md:w-64 space-y-2 px-4 lg:px-0 md:px-0">
          {tabs.map((tab) => {
            const Icon = tab.icon;
            return (
              <button
                  ...
                  {(["MZN", "USD", "EUR"] as CurrencyCode[]).map((code) => {
                    ...
                    return (
                      <button
                        ...
                        onClick={() => {
                          setCurrency(code);
                          toast.success(`Moeda alterada para ${c.label}`, {
                            duration: 1500,
                          });
                        }}
                        className={cn(
                        ...
                        <div
                          className={cn(
                            ...
                            isActive
                              ...
                              : "bg-white dark:bg-slate-700 text-gray-500 dark:text-gray-300",
                          )}
                        >
                          {c.symbol}
                        </div>
                ...
                {[
                  {
                    key: "invoices",
                    title: "Novas Faturas",
                    desc: "Aviso quando uma nova fatura for gerada",
                  },
                  {
                    key: "appointments",
                    title: "Lembretes de Marcação",
                    desc: "Aviso 1 hora antes de cada consulta",
                  },
                  {
                    key: "monthlyReports",
                    title: "Relatórios Mensais",
                    desc: "Sumário financeiro todo dia 1 do mês",
                  },
                  {
                    key: "stockAlerts",
                    title: "Alertas de Stock",
                    desc: "Aviso quando recursos estão baixos",
                  },
                ].map((item) => (
                  <div
                    key={item.key}
            ...
            <div className="space-y-6">
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-3xl border border-blue-100 dark:border-blue-900/30 flex gap-4">
                ...
                <div>
                  ...
                  <button className="mt-3 text-xs font-black text-blue-900 dark:text-blue-300 uppercase tracking-widest hover:underline">
                    Configurar Agora
                  </button>
                </div>
              </div>
              <div className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="px-4 py-3 bg-gray-900 dark:bg-white dark:text-black text-white text-xs font-black rounded-2xl uppercase tracking-widest"
                    >
                      Alterar
                    </button>
                  </div>
                ...
                <div className="space-y-3 pt-2">
                  ...
                  <button
                    ...
                    className="w-full py-3 bg-primary text-white text-xs font-black rounded-2xl uppercase tracking-widest shadow-lg shadow-primary/20"
                  >
                    Confirmar Alteração
                  </button>
                </div>
              ...
              <div className="bg-gradient-to-br from-gray-900 to-black p-8 rounded-[2.5rem] text-white relative overflow-hidden shadow-2xl">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-sm font-bold text-gray-400 mb-8">
                    Válido até 31 de Outubro, 2024
                  </p>
                  <div className="flex gap-4">
                    <button className="px-6 py-3 bg-white text-black rounded-2xl text-xs font-black uppercase tracking-widest">
                      Gerir Assinatura
                    </button>
                    <button className="px-6 py-3 bg-white/10 text-white rounded-2xl text-xs font-black uppercase tracking-widest">
                      Ver Faturas
                    </button>
                  </div>
                </div>
          ...
          {activeTab === "backup" && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                >
                  <div className="w-12 h-12 bg-white dark:bg-slate-700 rounded-2xl flex items-center justify-center text-primary mb-4 shadow-sm">
                    <Database size={24} />
                  </div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Gere um backup completo da base de dados.
                  </p>
                </button>
                <button
                  onClick={() => toast.success("A exportar dados...")}
                ...
                >
                  <div className="w-12 h-12 bg-white dark:bg-slate-700 rounded-2xl flex items-center justify-center text-emerald-500 mb-4 shadow-sm">
                    <Globe size={24} />
                  </div>
                  <h4 className="font-bold text-gray-900 dark:text-white">
                    Exportar CSV
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Exporte clientes e faturas para Excel/CSV.
                  </p>
                </button>
              </div>
            </div>
